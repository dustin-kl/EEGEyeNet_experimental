...
preparation_config['preprocessing_path'] = 'synchronised_' + preparation_config['preprocessing']
...
preparation_config['SAVE_PATH'] = './data/segmentation/'
preparation_config['output_name'] = "Segmentation_stream_with_" + preparation_config['dataset']
preparation_config['output_name'] = preparation_config['output_name'] + '_' + preparation_config['preprocessing_path']
preparation_config['output_name'] = preparation_config['output_name']
...
#preparation_config['output_name'] = preparation_config['output_name'] + 'clustering'

##################################################################################
# We prepare some helper variables to locate the correct datasets and the files that we need and to use them.
preparation_config['LOAD_ANTISACCADE_PATH'] = './data/antisaccade_task_data/' + preparation_config['preprocessing_path'] + '/'
...
preparation_config['LOAD_DOTS_PATH'] = './data/dots_data/' + preparation_config['preprocessing_path'] + '/'
...
preparation_config['LOAD_PROCESSING_SPEED_PATH'] = './data/processing_speed_data/' + preparation_config['preprocessing_path'] + '/'
