...
class Ensemble_torch:
    ...
    def predict(self, testX):
        ...
        a,b,c = testX.shape
        a = self.batch_size - a % self.batch_size #TODO: remove this ugly hack 
        ...
        # Load best models again to update to use the models parameters that performed best on the validation set 
        self.load(self.path) 
        # Predict with these models 
